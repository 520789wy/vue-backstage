        ...
        <div class="login_box">
            ...
            <el-form ref="loginFormRef" :model="loginForm" :rules="loginRules"  label-width="0px" class="login_form">
                ...
                <el-form-item prop="username">
                  <el-input prefix-icon="iconfont iconyonghuming" v-model="loginForm.username" ></el-input>
                </el-form-item>
                <!-- 密码 -->
                <el-form-item prop="password">
                  <el-input type="password" prefix-icon="iconfont iconicon_huabanfuben" v-model="loginForm.password" ></el-input>
                </el-form-item>
                <!-- 按钮 -->
...
export default{
    ...
    methods:{
        submit(){//表单的预校验，预校验通过后需要配置axios；async与await需要同步使用
